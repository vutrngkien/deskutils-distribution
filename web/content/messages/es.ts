...
export const es = {
  ...
  'feedback.description': 'Elige una tecla. Escribe unas líneas. Envíalas a DeskUtils.',
  'feedback.kind.label': 'Tipo de comentario',
  'feedback.kind.bug': 'Error',
  'feedback.kind.feedback': 'Comentario',
  'feedback.kind.idea': 'Idea',
  'feedback.message.label': 'Tu comentario',
  'feedback.message.placeholder': '¿Qué funciona bien, qué podría mejorar o qué parece incorrecto?',
  'feedback.email.label': 'Dirección de correo',
  'feedback.email.placeholder': '¿Dónde podemos responderte?',
  'feedback.attachment.add': 'Adjuntar imagen',
  'feedback.attachment.change': 'Cambiar imagen',
  'feedback.attachment.hint': 'Opcional · Una imagen de hasta 3 MB',
  'feedback.submit': 'Enviar comentario',
  'feedback.submit.sending': 'Enviando…',
  'feedback.privacy': 'No necesitas una cuenta de DeskUtils. Tu correo nunca se comparte.',
  'feedback.unavailable': 'Los envíos están temporalmente no disponibles. Escribe a',
  'feedback.error.message': 'Describe tu comentario antes de enviarlo.',
  'feedback.error.email': 'Introduce un correo válido para que podamos responderte.',
  'feedback.error.imageType': 'Elige un archivo de imagen.',
  'feedback.error.imageSize': 'Elige una imagen de menos de 3 MB.',
  'feedback.error.unavailable': 'Los envíos están temporalmente no disponibles.',
  'feedback.error.submit':
    'No pudimos enviar tu comentario. Inténtalo de nuevo o escribe a soporte.',
  'feedback.success.title': 'Gracias por tus comentarios.',
