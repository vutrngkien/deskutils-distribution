...
export const ja = {
  ...
  'feedback.description': '種類を選び、数行書いて、DeskUtils に送信してください。',
  'feedback.kind.label': 'フィードバックの種類',
  'feedback.kind.bug': '不具合',
  'feedback.kind.feedback': 'フィードバック',
  'feedback.kind.idea': 'アイデア',
  'feedback.message.label': 'フィードバック内容',
  'feedback.message.placeholder':
    'うまくいっている点、改善できる点、問題だと思う点を教えてください。',
  'feedback.email.label': 'メールアドレス',
  'feedback.email.placeholder': '返信先を教えてください',
  'feedback.attachment.add': '画像を添付',
  'feedback.attachment.change': '画像を変更',
  'feedback.attachment.hint': '任意 · 画像1枚、最大3 MB',
  'feedback.submit': 'フィードバックを送信',
  'feedback.submit.sending': '送信中…',
  'feedback.privacy':
    'DeskUtils アカウントは不要です。メールアドレスが共有されることはありません。',
  'feedback.unavailable': '現在フィードバックを送信できません。次のアドレスにメールしてください:',
  'feedback.error.message': '送信する前にフィードバック内容を入力してください。',
  'feedback.error.email': '返信できるよう、有効なメールアドレスを入力してください。',
  'feedback.error.imageType': '画像ファイルを選択してください。',
  'feedback.error.imageSize': '3 MB 未満の画像を選択してください。',
  'feedback.error.unavailable': '現在フィードバックを送信できません。',
  'feedback.error.submit':
    'フィードバックを送信できませんでした。もう一度試すか、サポートにメールしてください。',
  'feedback.success.title': 'フィードバックをありがとうございます。',
  'feedback.success.body': 'DeskUtils に送信されました。詳細が必要な場合はご連絡します。',
  'feedback.success.again': '別のフィードバックを送る',
