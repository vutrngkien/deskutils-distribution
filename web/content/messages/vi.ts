...
export const vi = {
  ...
  'feedback.description': 'Chọn một phím. Viết vài dòng. Gửi đến DeskUtils.',
  'feedback.kind.label': 'Loại phản hồi',
  'feedback.kind.bug': 'Lỗi',
  'feedback.kind.feedback': 'Phản hồi',
  'feedback.kind.idea': 'Ý tưởng',
  'feedback.message.label': 'Phản hồi của bạn',
  'feedback.message.placeholder':
    'Điều gì đang tốt, điều gì có thể tốt hơn, hay có gì đó chưa đúng?',
  'feedback.email.label': 'Địa chỉ email',
  'feedback.email.placeholder': 'Chúng tôi có thể trả lời ở đâu?',
  'feedback.attachment.add': 'Đính kèm ảnh',
  'feedback.attachment.change': 'Đổi ảnh',
  'feedback.attachment.hint': 'Không bắt buộc · Một ảnh, tối đa 3 MB',
  'feedback.submit': 'Gửi phản hồi',
  'feedback.submit.sending': 'Đang gửi…',
  'feedback.privacy': 'Không cần tài khoản DeskUtils. Email của bạn không bao giờ được chia sẻ.',
  'feedback.unavailable': 'Tạm thời không thể gửi phản hồi. Vui lòng email',
  'feedback.error.message': 'Vui lòng mô tả phản hồi trước khi gửi.',
  'feedback.error.email': 'Nhập email hợp lệ để chúng tôi có thể phản hồi.',
  'feedback.error.imageType': 'Vui lòng chọn tệp hình ảnh.',
  'feedback.error.imageSize': 'Chọn ảnh nhỏ hơn 3 MB.',
  'feedback.error.unavailable': 'Tạm thời không thể gửi phản hồi.',
  'feedback.error.submit': 'Không thể gửi phản hồi. Hãy thử lại hoặc email cho bộ phận hỗ trợ.',
  'feedback.success.title': 'Cảm ơn phản hồi của bạn.',
  'feedback.success.body':
    'Phản hồi đã được gửi đến DeskUtils. Chúng tôi sẽ liên hệ nếu cần thêm chi tiết.',
